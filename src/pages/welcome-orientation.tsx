        ...
        <Card className="shadow-lg rounded-2xl p-6 bg-white">
          <CardContent>
            ...
            <p className="text-gray-700 text-lg text-center mb-6">
              You’ve taken the first step towards optimizing your business operations
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>
                <strong>Assessment Tool:</strong> Identify inefficiencies and receive AI-driven insights.
              </li>
              <li>
                <strong>Value Stream Mapping (VSM) Tool:</strong> Optimize your workflows with real-time recommendations.
              </li>
              <li>
                <strong>Personalized AI Guidance:</strong> ArminX, your AI Sensei, will guide you through your transformation journey.
              </li>
            </ul>
